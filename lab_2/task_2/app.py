...
from common.plot_widget.controllers import RectSelectionController, ResizeController
from common.plot_widget.objects import Curve, Point, RectArea
...
class Task2Window(QWidget):
    ...
    def _init_objects(self):
        ...
        self._function_1_editor.editingFinished.connect(
            self._update_function(self._function_1_editor, self._func_1_graphic)
        )
        self._function_2_editor.editingFinished.connect(
            self._update_function(self._function_2_editor, self._func_2_graphic)
        )
